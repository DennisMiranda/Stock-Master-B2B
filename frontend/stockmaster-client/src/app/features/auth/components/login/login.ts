...
import { LucideAngularModule, Mail, Lock, ArrowLeft } from 'lucide-angular';
  ...
  onForgotPassword() {
    ...
    this.authService.sendPasswordResetEmail(this.email()).subscribe({
      next: () => {
        ...
        alert(
          '¡Correo enviado! Revisa tu bandeja de entrada para restablecer tu contraseña. (Revisa Spam)'
        );
